...
# Note: consider which variables have to be extrinsically defined, and which have to be diefined through context
# Note: consider triggers for messages (i.e. are they a response or a continuation)
